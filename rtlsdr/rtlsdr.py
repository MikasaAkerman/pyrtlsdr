...
from .librtlsdr import (
    ...
    dithering_supported,
    gpio_output_supported,
    gpio_input_supported,
    gpio_bit_supported,
    gpio_byte_supported,
    gpio_status_supported,
)
